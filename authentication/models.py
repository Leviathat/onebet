...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    balance = models.PositiveIntegerField(default=0, null=True, blank=True, verbose_name='Баланс')
    iin = models.PositiveSmallIntegerField(db_index=True, max_length=12, unique=True)
